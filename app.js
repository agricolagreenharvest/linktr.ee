...
const socials = [
  { icon:"fa-brands fa-whatsapp",  label:"WhatsApp",  url:"https://wa.me/+51977618065" },
  { icon:"fa-solid fa-location-dot", label:"Google Maps", url:"https://maps.app.goo.gl/41FStKuYBFStBGVy6" },
  { icon:"fa-solid fa-globe",    label:"Web",    url:"https://www.universidadperu.com/empresas/agricola-green-harvest.php"  },
  { icon:"fa-brands fa-linkedin-in", label:"LinkedIn",  url:"https://www.linkedin.com/company/omleurope"  },
];

const linksData = [
  {
    title: "Vladimir Castillo | DIRECTOR COMERCIAL",    url: "https://wa.me/+51977618065",icon: "fa-solid fa-user"},
  {title: "WhatsApp Ventas", url: "https://wa.me/+51977618065",icon: "fa-brands fa-whatsapp"},
  {title: "Agrícola Green Harvest", url: "https://www.universidadperu.com/empresas/agricola-green-harvest.php",icon: "fa-solid fa-globe"},
  {title: "Google Maps",url: "https://maps.app.goo.gl/41FStKuYBFStBGVy6",icon: "fa-solid fa-location-dot"},
  {title: "Correo Electrónico", url: "mailto:vladimir325@hotmail.com?subject=Consulta%20de%20ventas",icon: "fa-solid fa-envelope"},
];
